...
export default class editarPonto extends Component{
  ...
  PontoPost = () =>{
    ...
    const url = `http://127.0.0.1:5000/v1/pontos/${this.props.chave}/${"14014396794"}/`
      ...
      <div className='container col-7 mt-3'>
        ...
        <form>
          ...
          <div className="form-group mt-3 row text-center">
            <div className='col-4'>
              <Link onClick={() => {this.PontoPost()}}  style={{"text-decoration": 'none'}} to={this.state.return === '' && '/'} className='btn-lg btn-success mr-5'>
                Editar
              </Link>
            </div>
